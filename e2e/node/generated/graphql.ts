...
export type BookFragmentPartsFragment = { __typename: 'Book', id: string, title: string } & {
    ' $fragmentName'?: 'BookFragmentPartsFragment'
};
...
export type GetBookWithFragmentsQuery = {
    __typename: 'Query', book: (
        { __typename: 'Book' }
...
export type GotUnionUserQuery = {
    ...
    unionUser: {
        ...
        birthYYYYMM: string | null
    } | {
        __typename: 'UserIsBlocked',
        message: string | null,
        blockedByUser: { __typename: 'User', id: string, name: string | null } | null
    } | { __typename: 'UserSuspended' } | null
};

export type GetUserNamesArrayExampleQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserNamesArrayExampleQuery = {
    __typename: 'Query',
    userNamesArray: { __typename: 'UserNamesArrayExample', names: Array<string> }
};
...
export type CreateBookInlineMutation = {
    __typename: 'Mutation',
    createBookInline: { __typename: 'Book', id: string, title: string }
};

export type UseMutationErrorPatternMutationMutationVariables = Exact<{ [key: string]: never; }>;


export type UseMutationErrorPatternMutationMutation = {
    __typename: 'Mutation',
    useMutationErrorPattern: {
        __typename: 'UseMutationErrorPatternPayload',
        errors: Array<{ __typename: 'AbcError', message: string, code: AbcErrorCode, localizedMessage: string } | {
            __typename: 'GeneralError',
            message: string
        }>
    }
...
export type CreateFooUrlMutation = {
    __typename: 'Mutation',
    createFooURL: {
        __typename: 'FooURLPayload',
        URL: string,
        errors: Array<{ __typename: 'CreateFooURLErrorDetail', code: CreateFooUrlErrorCode, message: string }>
    }
};

export const BookFragmentPartsFragmentDoc = {
    "kind": "Document",
    "definitions": [{
        "kind": "FragmentDefinition",
        "name": { "kind": "Name", "value": "BookFragmentParts" },
...
} as unknown as DocumentNode<BookFragmentPartsFragment, unknown>;
...
export const GetBookWithFragmentsDocument = {
    "kind": "Document",
    "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": { "kind": "Name", "value": "GetBookWithFragments" },
        "variableDefinitions": [{
...
} as unknown as DocumentNode<GetBookWithFragmentsQuery, GetBookWithFragmentsQueryVariables>;
...
export const GotUnionUserDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": { "kind": "Name", "value": "GotUnionUser" },
        "selectionSet": {
            "kind": "SelectionSet",
            "selections": [{
                "kind": "Field",
                "name": { "kind": "Name", "value": "unionUser" },
                "selectionSet": {
                    "kind": "SelectionSet",
                    "selections": [{
                        "kind": "InlineFragment",
                        ...
                        "selectionSet": {
                            ...
                            }, { "kind": "Field", "name": { "kind": "Name", "value": "birthYYYYMM" } }]
                        }
                    }, {
                        "kind": "InlineFragment",
                        "typeCondition": { "kind": "NamedType", "name": { "kind": "Name", "value": "UserIsBlocked" } },
                        "selectionSet": {
                            "kind": "SelectionSet",
                            "selections": [{
                                "kind": "Field",
                                ...
                                "kind": "Field",
                                "name": { "kind": "Name", "value": "blockedByUser" },
                                "selectionSet": {
                                    "kind": "SelectionSet",
                                    "selections": [{
                                        "kind": "Field",
...
} as unknown as DocumentNode<GotUnionUserQuery, GotUnionUserQueryVariables>;
export const GetUserNamesArrayExampleDocument = {
    "kind": "Document",
    "definitions": [{
        "kind": "OperationDefinition",
        "operation": "query",
        "name": { "kind": "Name", "value": "GetUserNamesArrayExample" },
        "selectionSet": {
            "kind": "SelectionSet",
            "selections": [{
                "kind": "Field",
                "name": { "kind": "Name", "value": "userNamesArray" },
                "selectionSet": {
                    "kind": "SelectionSet",
                    "selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "names" } }]
                }
            }]
        }
    }]
} as unknown as DocumentNode<GetUserNamesArrayExampleQuery, GetUserNamesArrayExampleQueryVariables>;
...
export const CreateBookInlineDocument = {
    ...
    "definitions": [{
        "kind": "OperationDefinition",
        "operation": "mutation",
        "name": { "kind": "Name", "value": "CreateBookInline" },
        "variableDefinitions": [{
            "kind": "VariableDefinition",
            "variable": { "kind": "Variable", "name": { "kind": "Name", "value": "title" } },
            "type": {
        ...
        "selectionSet": {
            ...
            "selections": [{
                ...
                "arguments": [{
                    ...
                    "kind": "Argument",
                    "name": { "kind": "Name", "value": "bookTitle" },
                    "value": { "kind": "Variable", "name": { "kind": "Name", "value": "title" } }
                }],
                "selectionSet": {
                    "kind": "SelectionSet",
...
} as unknown as DocumentNode<CreateBookInlineMutation, CreateBookInlineMutationVariables>;
export const UseMutationErrorPatternMutationDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "mutation",
        "name": { "kind": "Name", "value": "UseMutationErrorPatternMutation" },
        "selectionSet": {
            "kind": "SelectionSet", "selections": [{
                ...
                "selectionSet": {
                    "kind": "SelectionSet", "selections": [{
                        "kind": "Field", "name": { "kind": "Name", "value": "errors" }, "selectionSet": {
                            "kind": "SelectionSet",
                            "selections": [{
                                "kind": "InlineFragment",
                                "typeCondition": {
                                    "kind": "NamedType",
                                    "name": { "kind": "Name", "value": "GeneralError" }
                                },
                                "selectionSet": {
                                    "kind": "SelectionSet",
                                ...
                                "selectionSet": {
                                    ...
                                    }, { "kind": "Field", "name": { "kind": "Name", "value": "localizedMessage" } }]
                                }
                            }, {
                                "kind": "InlineFragment",
                                "typeCondition": {
                                    "kind": "NamedType",
                                    "name": { "kind": "Name", "value": "DisplayableError" }
                                },
                                "selectionSet": {
                                    "kind": "SelectionSet",
                                    "selections": [{
                                        "kind": "Field",
                                        "name": { "kind": "Name", "value": "localizedMessage" }
...
} as unknown as DocumentNode<UseMutationErrorPatternMutationMutation, UseMutationErrorPatternMutationMutationVariables>;
export const CreateFooUrlDocument = {
    "kind": "Document", "definitions": [{
        "kind": "OperationDefinition",
        "operation": "mutation",
        ...
        "variableDefinitions": [{
            ...
            "type": {
                "kind": "NonNullType",
                "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "FooURLInput" } }
            }
        }],
        "selectionSet": {
            "kind": "SelectionSet",
                    ...
                    "selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "URL" } }, {
                        ...
                        "selectionSet": {
                            ...
                            "selections": [{
                                ...
                                "typeCondition": {
                                    "kind": "NamedType",
                                    "name": { "kind": "Name", "value": "CreateFooURLErrorDetail" }
                                },
                                "selectionSet": {
                                    "kind": "SelectionSet",
                                    "selections": [{
...
} as unknown as DocumentNode<CreateFooUrlMutation, CreateFooUrlMutationVariables>;
