...
export type ListDestinationCandidatesQuery = {
    __typename?: "Query";
    destinationCandidates: Array<{ __typename?: "Destination"; id: string; name: string }>;
};
...
export type CreateRideHistoryMutation = {
    __typename?: "Mutation";
    createRideHistory: { __typename?: "RideHistoryOutput"; id: string; name: string };
};
...
} as unknown as DocumentNode<ListRideHistoriesQuery, ListRideHistoriesQueryVariables>;
export const CreateRideHistoryDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "CreateRideHistory" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "desinationName" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
                    },
...
} as unknown as DocumentNode<CreateRideHistoryMutation, CreateRideHistoryMutationVariables>;
